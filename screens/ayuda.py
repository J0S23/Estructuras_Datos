...
def render_ayuda(screen, font=None, small_font=None):
    ...
    lineas = [
        ...
        "",
        "Con [D] hablas con un habitante de Ciudad Nova. Lo que le respondas",
        "también mueve los indicadores: ayudarlo a dudar de un rumor mejora la",
        "información verificada; animarlo a regarlo la empeora.",
        "",
